<table class="table table-bordered table-xs">
        <tbody>
            <tr style="background: #234673">
                ...
                <th width="25%" style="text-align:center;color:#fff;">Bobot</th>
            </tr>
            ...
            <tr>
                ...
                <th>
                    <div class="input-group mb-3">
                        <input type="number" step="0.01" class="form-control form-control-sm" style="width: 70px;"
                            value="7.62" />
